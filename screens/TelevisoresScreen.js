...
const localImages = {
  // "TV-01.png": require("../assets/images/Televisores/TV-01.png"),
  // Agrega aquí más imágenes de televisores
};
...
export default function TelevisoresScreen({ navigation }) {
  ...
  useEffect(() => {
    const fetchProductos = async () => {
      try {
        setLoading(true);
        const snapshot = await getDocs(collection(db, "televisores"));
          ...
          <View style={styles.heroSection}>
            <View style={styles.heroContent}>
              ...
              <Text style={[styles.heroSubtitle, { fontFamily: fontFamilyOrDefault("Aller_Rg") }]}>
                Televisores y soportes para tu entretenimiento
              </Text>
            </View>
          </View>
